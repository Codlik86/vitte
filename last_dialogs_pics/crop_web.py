#!/usr/bin/env python3
"""
Web-based Image Cropper for 736x414 (story cards)
...
IMAGES = sorted([
    ...
    if f.suffix.lower() in IMAGE_EXTENSIONS and f.name not in ['crop_web.py']
])
...
<body>
    <div class="container">
        ...
        <div class="instructions">
            <h3>Инструкция:</h3>
            <ul>
                <li>Кликай и тяни мышкой по картинке, чтобы двигать зелёную рамку</li>
                <li>Используй стрелки на клавиатуре для точной настройки</li>
                <li>Нажми "Save & Next" чтобы сохранить и перейти к следующей</li>
                <li>"Skip" - пропустить без сохранения</li>
            </ul>
        </div>
        ...
        <div class="canvas-container" id="canvas-container">
            ...
            <div class="crop-label" id="crop-label">736 x 414</div>
        </div>
