...
const AVATARS: Record<string, { card: string; chat: string }> = {
  ...
  "мей": { card: pub("personas/custom-card.jpg"), chat: pub("personas/custom-chat.jpg") },
  "стейси": { card: pub("personas/custom-card.jpg"), chat: pub("personas/custom-chat.jpg") },
  "тая": { card: pub("personas/custom-card.jpg"), chat: pub("personas/custom-chat.jpg") },
};
