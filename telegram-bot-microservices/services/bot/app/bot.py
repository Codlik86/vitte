...
from app.handlers import start_router, help_router, status_router, onboarding_router, menu_router, chat_router, subscription_router, shop_router, upgrades_router
