...
- none — нет активного полового акта

ПРАВИЛА:
1. Верни ТОЛЬКО одно слово — название позы или none
2. Если активный половой акт идёт, но поза не ясна — верни missionary
3. Верни none если это: флирт, поцелуи, объятия, раздевание, прелюдия, ласки, массаж, романтика, стриптиз, прикосновения — даже очень откровенные
4. Верни позу ТОЛЬКО если в тексте явно описывается проникновение или активный половой акт (трахает, входит, двигается внутри, ритм, кончает и т.п.)
