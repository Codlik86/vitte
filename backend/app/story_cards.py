...
STORY_CARDS: Dict[str, List[StoryCard]] = {
    ...
    "стейси": [
        ...
        image="personas/stacey-story-massage_long.jpg",
    ),
        StoryCard(
        id="stacey_mutual",
        key="mutual",
        ...
        image="personas/stacey-story-mutual.jpg",
    ),
        StoryCard(
        id="stacey_feet",
        key="feet",
        ...
        image="personas/stacey-story-feet.jpg",
    ),
        StoryCard(
        id="stacey_home",
        key="home",
        ...
        image="personas/stacey-story-home.jpg",
    ),
    ],
    "тая": [
        StoryCard(
