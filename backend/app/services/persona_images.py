...
PERSONA_CONFIGS: Dict[str, PersonaImageConfig] = {
    ...
    "mei": PersonaImageConfig(
        lora_filename="VNFXMJJ7VR6P2ZDF2JWBH0MGZ0.safetensors",
        trigger_word="young woman",
        master_prompt="She has black hair and gorgeous deep brown eyes, and she's in her early twenties.",
        prompt_core="medium long shot, upper body to thighs",
        negative_prompt=DEFAULT_NEGATIVE,
        lora_strength_model=1.0,
        lora_strength_clip=1.0,
    ...
    "taya": PersonaImageConfig(
        lora_filename="Elise_XWMB_zimage.safetensors",
        trigger_word="Elise_XWMB, she has blonde hair",
        master_prompt="milf with huge breasts",
        prompt_core="medium long shot, upper body to thighs",
        negative_prompt=DEFAULT_NEGATIVE,
